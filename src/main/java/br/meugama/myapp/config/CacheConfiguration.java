package br.meugama.myapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.meugama.myapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.meugama.myapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
